...
const serverUrl = "https://j4fun3hzmo7m.usemoralis.com:2053/server";
const appId = "McYwHvaG18ugl5FPZzolSz6oSTkojYVIfhuEKi7U";
Moralis.start({ serverUrl, appId });

let currentTrade = {};
let curretntSelectSide;
let tokens;

async function init(){
  await Moralis.initPlugins();
  await Moralis.enableWeb3();
  await listAvilableToken();
  
}

async function listAvilableToken(){
...
function selectToken(address){
  closeModal();
  console.log(tokens);
  currentTrade[curretntSelectSide] = tokens[address];
